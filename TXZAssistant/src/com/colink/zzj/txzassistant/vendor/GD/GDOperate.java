...
public class GDOperate {
	...
	public void startNavigation(double lat, double lon) {
		...
		if (APPUtil.getInstance().isInstalled(APPUtil.GD_CARJ_PKG)) {
			...
			String dat = "androidauto://navi?sourceApplication=TXZAssistant&lat=" + lat + "&lon=" + lon + "&dev=0&style=2";
			Intent i = new Intent();
			...
			String cat = "android.intent.category.DEFAULT";
			String dat = "androidamap://navi?sourceApplication=TXZAssistant&lat=" + lat + "&lon=" + lon + "&dev=0&style=2";
			Intent i = new Intent();
			i.setData(android.net.Uri.parse(dat));
