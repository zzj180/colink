...
package com.zzj.softwareservice.weather;
...
import com.zzj.softwareservice.R;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					L.v("getStatusCode = " + response.getStatusLine().getStatusCode());
