...
public class ContactActivity extends Activity implements OnClickListener,
	...
	private static int DOWNLOAD_ID = 2;
	private static int CONTACT_ID = 3;
	...
	private BroadcastReceiver receiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (Constact.ACTION_CONTACT_DONE.equals(action))
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		filter.addAction(Constact.ACTION_CONTACT_DONE);
		...
		dialog.setOnPositiveListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mService != null) {
					...
					myAsyncQueryHandler.startDelete(DOWNLOAD_ID, null,TelphoneService.RAW_CONTENT_URI, null, null);
				}
				dialog.dismiss();
			}
