...
public class FunctionHelpViewAdapter extends BaseAdapter{
	...
	public FunctionHelpViewAdapter(Context context,
			ArrayList<FunctionHelpTextInfo> lists) {
		super();
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		Logger.d(TAG, "!--->getView:-Before Check--domainType = "+domainType+"; domainHelpText = "+domainHelpText);
		domainHelpText = checkHelpTextByType(domainType, domainHelpText);
		Logger.d(TAG, "!--->getView:-After Check--domainType = "+domainType+"; domainHelpText = "+domainHelpText);
	...
	private String checkHelpTextByType(String domainType, String domainHelpText){
		...
		//		if (SessionPreference.DOMAIN_CALL.equals(domainType)) {
					domainHelpText = mContext.getResources().getStringArray(R.array.function_example_call_no_contact)[0];
		//		} else {
		//			domainHelpText = mContext.getResources().getStringArray(R.array.function_example_sms_no_contact)[0];
		//		}
			} else {
