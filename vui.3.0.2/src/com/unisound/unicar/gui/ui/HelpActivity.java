...
public class HelpActivity extends Activity {
    ...
    private int[] childContent = {R.array.help_child_content_1, R.array.help_child_content_2,
            R.array.help_child_content_3, R.array.help_child_content_4,
            R.array.help_child_content_5, R.array.help_child_content_6,
            R.array.help_child_content_7};
    private ExpandableListAdapter mAdapter = new BaseExpandableListAdapter() {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
                ViewGroup parent) {
            convertView = getLayoutInflater().inflate(R.layout.help_listview_menu_title, null);
            TextView text = (TextView) convertView.findViewById(R.id.menuTitleTxt);
            text.setText(getGroup(groupPosition).toString());
            ImageView imgIndicator = (ImageView) convertView.findViewById(R.id.foldBtn);
            if (isExpanded) {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            convertView = getLayoutInflater().inflate(R.layout.help_listview_submenu, null);
            TextView text = (TextView) convertView.findViewById(R.id.subMenuTxt);
            text.setText(Html.fromHtml(getChild(groupPosition, childPosition).toString()));
            return convertView;
        }
