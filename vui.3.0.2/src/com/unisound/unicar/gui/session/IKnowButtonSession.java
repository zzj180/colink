...
/**
 * eg: “打电话”-->“打电话给谁？”-->"zhang san" --> No person --> I Know eg: “打电话”-->“打电话给谁？”-->"zhang san"
 * --> One person --> No Number --> I Know 没有找到相关的联系人. 我知道了 --> 点击退出 TTS播报完毕 退出
 * 
 * @author xiaodong
 * @date 20150626
 */
public class IKnowButtonSession extends CommBaseSession {
    ...
    public void putProtocol(JSONObject jsonProtocol) {
        ...
        if (mIKnowView == null) {
            ...
            } else if (SessionPreference.VALUE_LOCATION_RESULT_TIMEOUT.equals(mType)) {
                mIKnowView.setShowText(R.string.search_timeout);
    ...
    private boolean isNewSessionStart = false;

    @Override
    public void onNewSessionStart() {
        super.onNewSessionStart();
    ...
    public void onTTSEnd() {
        super.onTTSEnd();
        Logger.d(TAG, "onTTSEnd----SESSION_DONE--isNewSessionStart=" + isNewSessionStart);
