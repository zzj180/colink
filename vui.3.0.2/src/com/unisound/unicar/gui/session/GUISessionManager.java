...
public class GUISessionManager {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SessionPreference.MESSAGE_SHOW_EDIT_LOCATION_POP:
                    ...
                    mWindowService.showChangeTextPopWindow(WindowService.POP_TYPE_EDIT_LOCATION);
                    break;
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:
                   ...
                   /* Logger.d(TAG,
                            "STREAM_MUSIC Volume after:" + mAudioManager.getStreamVolume(AudioManager.STREAM_MUSIC));
                    Logger.d(
                            TAG,
    ...
    public void onTalkRecordingResult(String result, boolean isPartial) {
        if (!GUIConfig.isShowASRRecordResult) {
            Logger.d(TAG,
                    "!--->onTalkRecordingResult--GUIConfig isShowASRRecordResult false---result = "
                            + result);
            return;
        }
        result = getRecordingResultByResultType(result, isPartial);// XD added 20150906
        Logger.d(TAG, "!--->onTalkRecordingResult----result = " + result + "; isPartial = "
                + isPartial + "; isNeedShowMicStatusSessionView = "
                + isNeedShowMicStatusSessionView());
        if (isNeedShowMicStatusSessionView()) {
    ...
    private void createSession(String protocal) {
        ...
        if (obj != null) {
            ...
            } else if (SessionPreference.VALUE_SCHEDULE_TYPE_ACTION_CANCEL.equals(mType)) {// xd
                                                                                           // added
            ...
            // TODO add by ch Traffic
                ...
                // TODO:
                base = new ChatWebShowSession(mWindowService, mSessionManagerHandler);
                showAsrResultTextOnMicView(mWindowService
