...
public class LocalSearchRouteShowSession extends BaseSession {
	...
	public void startNavi(double toLat, double toLng, String fromPoi,
		...
		// sourceLatLng待转换坐标  
		//先将高德坐标转换为百度坐标
		LatLng pt1 = new LatLng(mFromLat, mFromLng);
		...
		Logger.d(TAG, "from lng : [ " + mFromLat + " -- " + mFromLng + " ]");
...
/*		NaviPara para = new NaviPara();
		...
		//	BaiduMapNavigation.openBaiduMapNavi(para, mContext);
			RomDevice.showRoute(mContext, GaodeMap.ROUTE_MODE_DRIVING, mFromLat, mFromLng, "", fromPoi, to.latitude, to.longitude, "", toPoi);
