...
public class MultipleLocationSession extends SelectCommonSession {
    ...
    private PickLocationViewListener mPickLocationViewListener = new PickLocationViewListener() {
        ...
        public void onEditLocationClick() {
            Logger.d(TAG, "onEditLocationClick-----");
            if (null != mSessionManagerHandler) {
                mSessionManagerHandler
                        .sendEmptyMessage(SessionPreference.MESSAGE_SHOW_EDIT_LOCATION_POP);
            }
    ...
    public void putProtocol(JSONObject jsonProtocol) {
        ...
        Logger.d("putProtocol----jsonProtocol----", jsonProtocol.toString());
        String locationToPoi = JsonTool.getJsonValue(mDataObject, "locationToPoi");
        ...
        if (dataArray != null) {
            ...
            if (mPickLocationView == null) {
                ...
                mPickLocationView.initView(mLocationInfos, locationToPoi);
