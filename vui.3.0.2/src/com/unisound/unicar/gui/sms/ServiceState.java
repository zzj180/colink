...
public class ServiceState implements Parcelable {
    ...
    /**
     * Normal operation condition, the phone is registered with an operator either in home network
     * or in roaming.
     */
    public static final int STATE_IN_SERVICE = 0;

    /**
     * Phone is not registered with any operator, the phone can be currently searching a new
     * operator to register to, or not searching to registration at all, or registration is denied,
     ...
     * 
     * This method is used by PhoneStateIntentReceiver and maybe by external applications.
     * 
     ...
     * 
     * @return true if TS 27.007 7.2 roaming is true and ONS is different from SPN
     * 
     */
     ...
     * 
     * In GSM/UMTS, long format can be upto 16 characters long In CDMA, returns the ERI text, if
     * set, otherwise the ONS
     * 
    ...
    @Override
    public int hashCode() {
        return ((mState * 0x1234) + (mRoaming ? 1 : 0) + (mIsManualNetworkSelection ? 1 : 0)
                ...
                + mCdmaRoamingIndicator + mCdmaDefaultRoamingIndicator);
    }
    ...
    public boolean equals(Object o) {
        ...
        return (mState == s.mState && mRoaming == s.mRoaming
                && mIsManualNetworkSelection == s.mIsManualNetworkSelection
                ...
                && equalsHandlesNulls(mCdmaRoamingIndicator, s.mCdmaRoamingIndicator) && equalsHandlesNulls(
                    mCdmaDefaultRoamingIndicator, s.mCdmaDefaultRoamingIndicator));
    }
    ...
    public String toString() {
        ...
        return (mState + " " + (mRoaming ? "roaming" : "home") + " " + mOperatorAlphaLong + " "
                + mOperatorAlphaShort + " " + mOperatorNumeric + " "
                + (mIsManualNetworkSelection ? "(manual)" : "") + " " + radioTechnology + " "
                + (mCssIndicator ? "CSS supported" : "CSS not supported") + " " + mNetworkId + " "
                + mSystemId + "RoamInd: " + mCdmaRoamingIndicator + "DefRoamInd: " + mCdmaDefaultRoamingIndicator);
    }
    ...
    /**
     * In CDMA mOperatorAlphaLong can be set from the ERI text, this is done from the CDMAPhone and
     * not from the CdmaServiceStateTracker
     * 
     * @hide
     */
