/*
 * Copyright (C) 2008 Esmertec AG. Copyright (C) 2008 The Android Open Source Project Licensed under
...
public class SmsMessageSender implements MessageSender {
    ...
    private void queueMessage(long token) throws SmsException {
        ...
        for (int i = 0; i < mNumberOfDests; i++) {
            try {
                ...
                Sms.addMessageToUri(mContext.getContentResolver(),
                        Uri.parse("content://sms/queued"), mDests[i], mMessageText, null,
                        mTimestamp, true /* read */, DEFAULT_DELIVERY_REPORT_MODE, mThreadId);
        ...
        mContext.sendBroadcast(new Intent(SmsSenderService.ACTION_SEND_MESSAGE, null, mContext,
    ...
    private String getOutgoingServiceCenter(long threadId) {
        ...
        try {
            cursor =
                    SqliteWrapper
                            .query(mContext, mContext.getContentResolver(), Sms.CONTENT_URI,
