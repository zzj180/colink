...
public class SessionContainer extends ScrollView {
	...
	public SessionContainer(Context context, AttributeSet attrs, int defStyle) {
		...
		mSessionContainer.setGravity(Gravity.CENTER_VERTICAL);// XD added
																// 20150921
		...
		// int bottom =
		// res.getDimensionPixelSize(R.dimen.session_padding_bottom);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Logger.d(TAG, "!--->onTouchEvent---action = " + ev.getAction()
