...
public class MicrophoneControlDoresoView extends MicrophoneControlBaseView {
	...
	public static final String TAG = MicrophoneControlDoresoView.class
			.getSimpleName();
	...
	public MicrophoneControlDoresoView(Context context, AttributeSet attrs,
		...
		mCancelBtn = (ImageView) view.findViewById(R.id.cancelBtn);

		mFlDoresoScan = (FrameLayout) findViewById(R.id.fl_doreso_scan);
		mIvDoresoScan = (ImageView) findViewById(R.id.iv_doreso_scan);
		mVoiceLevel = (RoundVoiceLevelView) view
				.findViewById(R.id.my_voice_progress_bar);

		mTextViewAnswer = (TextView) view.findViewById(R.id.text_answer);

		mIvMicRecognitionBg = (ImageView) view
				.findViewById(R.id.ivMicRecognitionBtn);
		mImageViewMicRecognize = (ImageView) view
				.findViewById(R.id.imageViewRecognize);

		mIvRecordingRecording = (ImageView) view
				.findViewById(R.id.iv_recording_recording);
		...
		mRotateAnimationMicRecognize
				.setDuration(TIME_MINISECONDS_DURATION_DORESO_SCAN);
