...
public class ReceiveCallView extends RelativeLayout implements ISessionView {
	 ...
	 * @param location
	 */
	public ReceiveCallView(Context context, String name, String number,
			Drawable drawable, String location) {
		super(context);
		Logger.d(TAG, "!--->ReceiveCallView: name = " + name + "; number = "
				+ number);
		mName = name;
		mNumber = number;
		mLocation = location;
	...
	private void findViews() {
		View view = mLayoutInflater.inflate(R.layout.call_incoming_view, this,
				true);
		LinearLayout ll = (LinearLayout) view
				.findViewById(R.id.linearLayoutCALLTxtItem);
		TextView textViewHead = (TextView) ll.findViewById(R.id.callViewHead);
		TextView tvLoaction = (TextView) ll
				.findViewById(R.id.tv_incall_location);
		...
		textViewHead.setText(mContext.getString(
				R.string.call_incoming_title_contact, mName));
