...
public class BaiduMapLocationView extends BaseMapLocationView {
	...
	private static final String TAG = BaiduMapLocationView.class
			.getSimpleName();
	...
	private void getCurrentLocation() {
		...
		if (mLocationInfo != null) {
			...
			Logger.d(TAG, "mFromeCity = " + mFromeCity + "; mFromAddress = "
					+ mFromAddress + "; mFromLat = " + mFromLat
					+ "; mFromLng = " + mFromLng);
		}
	}
	...
	private void initView() {
		View view = LayoutInflater.from(mContext).inflate(
				R.layout.view_location_baidu_map, this, true);
