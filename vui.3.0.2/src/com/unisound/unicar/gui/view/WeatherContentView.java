...
public class WeatherContentView extends FrameLayout implements ISessionView {
	...
	private String TOMMOROW_STRING = getResources()
			.getString(R.string.tomorrow);
	private String DAY_AFTER_TOMMOROW_STRING = getResources().getString(
	...
	private String overcast = getResources().getString(
			R.string.weather_overcast);
	private String foggy = getResources().getString(R.string.weather_foggy);
	private String dustblow = getResources().getString(
			R.string.weather_dustblow);
	private String dust = getResources().getString(R.string.weather_dust);
	private String sandstorm = getResources().getString(
			R.string.weather_sandstorm);
	private String strong_sandstorm = getResources().getString(
			R.string.weather_sandstorm_strong);
	...
	private String thunder_rain = getResources().getString(
			R.string.weather_thunder_rain);
	...
	private String light_rain = getResources().getString(
			R.string.weather_rain_light);
	private String moderate_rain = getResources().getString(
			R.string.weather_rain_moderate);
	private String heavy_rain = getResources().getString(
			R.string.weather_rain_heavy);
	private String rainstorm = getResources().getString(
			R.string.weather_rainstorm);
	private String big_rainstorm = getResources().getString(
			R.string.weather_rainstorm_big);
	private String super_rainstorm = getResources().getString(
			R.string.weather_rainstorm_super);
	private String snow_shower = getResources().getString(
			R.string.weather_snow_shower);
	private String light_snow = getResources().getString(
			R.string.weather_snow_light);
	private String moderate_snow = getResources().getString(
			R.string.weather_snow_moderate);
	private String heavy_snow_big = getResources().getString(
			R.string.weather_snow_heavy);
	private String blizzard = getResources().getString(
	...
	private void initBigImageNameIdMap() {
		...
		mBigImageNameIdMap.put(strong_sandstorm,
				R.drawable.ic_weather_sandstorm_strong);
		mBigImageNameIdMap.put(icerain, R.drawable.ic_weather_icerain);
		mBigImageNameIdMap.put(shower, R.drawable.ic_weather_shower);
		mBigImageNameIdMap
				.put(thunder_rain, R.drawable.ic_weather_thunder_rain);
		...
		mBigImageNameIdMap.put(moderate_rain,
		...
		mBigImageNameIdMap.put(big_rainstorm,
				R.drawable.ic_weather_rainstorm_big);
		mBigImageNameIdMap.put(super_rainstorm,
				R.drawable.ic_weather_rainstorm_super);
		...
		mBigImageNameIdMap.put(moderate_snow,
				R.drawable.ic_weather_snow_moderate);
		mBigImageNameIdMap
				.put(heavy_snow_big, R.drawable.ic_weather_snow_heavy);
	...
	private void findViews() {
		...
		tv_otherday_temperature_second = (TextView) findViewById(R.id.tv_otherday_temperature_second);
		...
		tv_otherday_temperature_fourth = (TextView) findViewById(R.id.tv_otherday_temperature_fourth);

		rl_weather_others = new RelativeLayout[] { rl_weather_other_first,
				rl_weather_other_second, rl_weather_other_third,
				rl_weather_other_fourth };
		tv_otherday_titles = new TextView[] { tv_otherday_title_first,
				tv_otherday_title_second, tv_otherday_title_third,
				tv_otherday_title_fourth };
		iv_otherday_weathers = new ImageView[] { iv_otherday_weather_first,
				iv_otherday_weather_second, iv_otherday_weather_third,
				iv_otherday_weather_fourth };
		tv_otherday_weathers = new TextView[] { tv_otherday_weather_first,
				tv_otherday_weather_second, tv_otherday_weather_third,
				tv_otherday_weather_fourth };
		tv_otherday_temperatures = new TextView[] {
				tv_otherday_temperature_first, tv_otherday_temperature_second,
				tv_otherday_temperature_third, tv_otherday_temperature_fourth };
	}

	public void setWeatherInfo(WeatherInfo weatherInfo, String mCity,
			String updateTime) {
		...
		String weatherDesc = weather + " " + lowestTemperature + "-"
		...
		String pm25Desc = getResources().getString(R.string.weather_pm25)
				+ pm25;
		textViewSetText(tv_weather_today_pm25, pm25Desc);

		String airQualityDesc = getResources().getString(
				R.string.weather_air_quality)
				+ airQuality;
		textViewSetText(tv_weather_today_airquality, airQualityDesc);

		String carWashIndexDesc = getResources().getString(
				R.string.weather_car_wash)
				+ carWashIndex;
		...
		// -----------------------------------------------------------------------------
		// today和其它日子的共同部分
		String updateTimeDesc = getResources().getString(
				R.string.weather_update_time)
				+ updateTime;
	...
	private void otherDaySetUi(int index) {
		...
		textViewSetText(tv_otherday_titles[index],
				getOtherDayTitle(mWeatherInfo, index));
		...
		String otherDay_temperatureDesc = tempDay.getLowestTemperature() + "-"
				+ tempDay.getHighestTemperature() + "°C";
		textViewSetText(tv_otherday_temperatures[index],
				otherDay_temperatureDesc);
	}
	...
	private String getOtherDayTitle(WeatherInfo weatherInfo, int index) {
		...
		default:
			return sDayOfWeekNames[(mWeatherInfo.getWeatherDay(index)
					.getDayOfWeek() + WEEK_TEMP_NUM) % WEEKDAY_NUM];
		}
	}
	...
	private Integer getWeatherImage(String imgTitle) {
		if (null == mBigImageNameIdMap) {
			...
			return mBigImageNameIdMap.containsKey(imgTitle) ? mBigImageNameIdMap
					.get(imgTitle) : mBigImageNameIdMap.get(overcast);
		}
	}
	...
	private void relativeLayoutSetBackgroudColor(
			RelativeLayout mRelativeLayout, int colorId) {
