...
public class FlightContentView extends FrameLayout implements ISessionView {
	...
	public FlightContentView(Context context, Handler mSessionManagerHandler,
			...
			mFlightWebView.setWebViewClient(new WebViewClient() {
				...
				public void onPageFinished(WebView view, String url) {
					...
					if (isFirstLoad && !isCancel) {
						...
						int height = (int) (mWindowManager.getDefaultDisplay()
								.getHeight() * SCALE_NUM);
						mFlightWebView.setLayoutParams(new LayoutParams(
	...
	private void playTTS(String ttsContent) {
		...
		bundle.putString(SessionPreference.KEY_BUNDLE_PROTOCAL, GuiProtocolUtil
				.getPlayTTSEventParam(ttsContent,
