...
public class TrafficControlView extends FrameLayout implements ISessionView {
	...
	public TrafficControlView(Context context,
			TrafficControlInfo mTrafficControlInfo) {
		super(context);
		mContext = context;
	...
	private void initView() {
		...
		tv_today = (TextView) view
				.findViewById(R.id.tv_traffic_control_number_today_1);
		tv_rule = (TextView) view
				.findViewById(R.id.tv_traffic_control_rule_content);
		initData();
	}
