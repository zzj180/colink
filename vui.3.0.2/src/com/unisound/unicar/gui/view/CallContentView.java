...
public class CallContentView extends FrameLayout implements ISessionView {
	...
	private void findViews() {
		...
		// mTextViewAttribution = (TextView)
		// findViewById(R.id.callDialogAttribution);
	...
	public void initView(Drawable drawable, String contactName,
			String phoneNumber, String attribution) {
		// if (drawable != null) {
		...
		tvTitleCallOutName.setText(getResources().getString(
				R.string.call_out_name, contactName));
	...
	public void startCountDownTimer(final long countDownMillis) {
		...
		mCountDownTimer = new CountDownTimer(countDownMillis, 100) {
			...
			public void onTick(long millisUntilFinished) {
				...
				// mProgressBarWaiting.setProgress(mProgressBarWaiting.getMax()
				// - progress);
