...
public class AMapLocationViewBake extends BaseMapLocationView {
	...
	private static final String TAG = AMapLocationViewBake.class
			.getSimpleName();
	...
	private void initView() {
		View view = LayoutInflater.from(mContext).inflate(
				R.layout.view_location_amap, this, true);
	...
	private LocationSource mLocationSource = new LocationSource() {
		...
		public void activate(OnLocationChangedListener listener) {
			...
			if (mLocationInfo != null) {
				if (mListener != null) {
					mListener
							.onLocationChanged(parse2AMapLocation(mLocationInfo));// 显示系统小蓝点
				}
			}
