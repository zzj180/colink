...
public class StockContentView extends FrameLayout implements ISessionView {
	...
	public void updateUI(StockInfo result) {
		...
		mTextViewTodayOpeningPrice.setText(getResources().getString(
				R.string.stock_pening_price, result.getTodayOpeningPrice()));
		mTextViewYesterdayClosingPrice.setText(getResources()
				.getString(R.string.stock_closing_price,
						result.getYesterdayClosingPrice()));
		mTextViewHighestPrice.setText(getResources().getString(
				R.string.stock_highest_price, result.getHighestPrice()));
		mTextViewLowestPrice.setText(getResources().getString(
				R.string.stock_lowest_price, result.getLowestPrice()));
