...
public class DialActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getAudioManager().requestAudioFocus(null, AudioManager.STREAM_MUSIC,
				AudioManager.AUDIOFOCUS_GAIN_TRANSIENT);
	/*	Intent service = new Intent(this, TelphoneService.class);
		bindService(service, conn, BIND_AUTO_CREATE);*/
		sliderLayout = (WaitSliderRelativeLayout)findViewById(R.id.slider_layout);
...
/*		time = Settings.System.getInt(getContentResolver(), NO_DIDTURB, -1);
		...
		if (intent != null) {
			...
			if ("4008015170".equals(mPhoneNumber)
					|| "075787807160".equals(mPhoneNumber)) {
				ComponentName componetName = new ComponentName(
						Constact.ECAR_APP, Constact.ECAR_SERVICE);
		...
		if (wakeLock == null) {
			...
			wakeLock = powerManager.newWakeLock(
					PowerManager.ACQUIRE_CAUSES_WAKEUP
							| PowerManager.SCREEN_DIM_WAKE_LOCK, getClass()
							.getCanonicalName());
		}
		wakeLock.acquire();
	}
