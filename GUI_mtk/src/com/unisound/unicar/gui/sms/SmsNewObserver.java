...
public class SmsNewObserver extends ContentObserver {
    ...
    protected static final String[] PORJECTION = new String[] {SMS._ID, SMS.TYPE, SMS.ADDRESS,
            SMS.BODY, SMS.DATE, SMS.THREAD_ID, SMS.READ, SMS.PROTOCOL, SMS.PERSON_ID};
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case 1001:
                    ...
                    Log.d(TAG, "handSmsBegin.getMessage() = " + handSmsBegin.getMessage()
                            + ";==handSmsEnd.getMessage()==" + handSmsEnd.getMessage());

                    if (handSmsBegin.getMessage() != null && handSmsBegin.getMessage().length() > 0) {
                        Log.d(TAG,
                                "Telephony.phoneIsInUse(mContext) = "
                                        + Telephony.phoneIsInUse(mContext));
                        if (!Telephony.phoneIsInUse(mContext)) {
    ...
    public void onChange(boolean change) {
        ...
        try {
            ...
            /** 2014-11-19 yujun */
            c =
                    mContext.getContentResolver().query(SMS.CONTENT_URI, PORJECTION, SELECTION,
                            new String[] {"0", "1"}, "date desc");// 获取条件(read = 0,type =1)的短信指针
            /** ------------------- */
                ...
                if (c.moveToFirst()) {
                    ...
                    Uri personUri =
                            Uri.withAppendedPath(ContactsContract.PhoneLookup.CONTENT_FILTER_URI,
                                    Uri.encode(phone));
                    Cursor cur =
                            mContext.getContentResolver().query(personUri,
