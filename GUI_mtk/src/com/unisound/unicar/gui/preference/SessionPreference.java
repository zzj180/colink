...
public class SessionPreference {
	...
	public static final String VALUE_SETTING_OBJ_COMPLAIN = "OBJ_COMPLAIN";
	
	public static final String VALUE_SETTING_OBJ_OBD = "OBJ_OBD";
	public static final String VALUE_SETTING_OBJ_DEMANDOIL = "OBJ_DEMANDOIL";
	public static final String VALUE_SETTING_OBJ_CRASPEED = "OBJ_CRASPEED";
	public static final String VALUE_SETTING_OBJ_OBDSERVICE = "OBJ_OBDSERVICE";
	public static final String VALUE_SETTING_OBJ_TRUNK = "OBJ_TRUNK";
    ...
    public static final String EVENT_NAME_MAIN_ACTION_KEYWORD = "MAIN_ACTION";
