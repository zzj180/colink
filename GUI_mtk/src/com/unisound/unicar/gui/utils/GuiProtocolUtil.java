...
public class GuiProtocolUtil {
     ...
     * @return
     */
    public static String getSettingProtocolParam(String state) {
     ...
     * @return
     */
    public static String getSetVersionLevelProtocol(String level) {
        return getSettingProtocolParam(level);
    }
