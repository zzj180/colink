...
public class LocalSearchRouteConfirmShowSession extends BaseSession {
	...
	private final int GOOGLE_INDEX = 4;
	private final int MEIXING_INDEX = 5;
...
*/
            ...
            case MEIXING_INDEX:
               /* Logger.d(TAG, "mapIndex : " + mapIndex + " use ritu route ...");
            	...
            	if(!isGaoDe){
            		Gps gps = PositionUtil.bd09_To_Gcj02(toLat, toLng);
            		toLat = gps.getWgLat();
            		toLng = gps.getWgLon();
            	}
            	Intent i = new Intent("com.mxnavi.mxnavi.PTT_DEST_ACTION");
            	String dest_string = "(TND,2,0, "+toLat+","+toLng+","+toPoi+")";
