...
public class AMapPoiAroundSearchView1 extends LinearLayout implements ISessionView {

    private static final String TAG = AMapPoiAroundSearchView1.class.getSimpleName();
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            switch (v.getId()) {
                case R.id.spinnerdeep:
                    Logger.d(TAG, "mOnFocusChangeListener---spinnerdeep---hasFocus = " + hasFocus);
