...
public class PickBaseView extends LinearLayout implements ISessionView {
   ...
   //     int height = res.getDimensionPixelSize(R.dimen.pick_view_cancel_button_height);
   //     int textSize = res.getDimensionPixelSize(R.dimen.pick_view_cancel_button_textsize);
        ...
        /*
         * mContainer = new LinearLayout(context); mContainer.setOrientation(VERTICAL);
         * addView(mContainer); mLayoutInflater = (LayoutInflater)
         * context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
         * mLayoutInflater.inflate(R.layout.pickphone_content_view, this, true); mBtnCancel =
         * (Button) findViewById(R.id.btnCancel); mBtnCancel.setOnClickListener(mOnClickListener);
         */
    }
    ...
    protected void addItem(View view) {
        Logger.d(
                TAG,
                "!--->addItem:--mHasHeader=" + mHasHeader + "; childCount = "
    ...
    protected void addBottomView(View view) {
        mBottomViewCount++;
        Logger.d(TAG, "!--->addButtomView:----mBottomViewCount = " + mBottomViewCount);
        mContainer.addView(view);
    }
    ...
    public int getItemCount() {
        Logger.d(TAG, "!--->getItemCount--mHasHeader = " + mHasHeader + "; mHasBottom = "
                + mHasBottom + "; mBottomViewCount = " + mBottomViewCount);
    ...
    public View getItem(int index) {
        ...
        if (index >= 0 && index < count) {
            return mHasHeader ? mContainer.getChildAt(index + 1) : mContainer.getChildAt(index);
        }
        return null;
    }
