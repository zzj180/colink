 ...
 * 
 * @FileName : FlightContentView.java
...
public class FlightContentView extends FrameLayout implements ISessionView {
    ...
    private static final String TAG = FlightContentView.class.getSimpleName();
    ...
    // private static final double SCALE_NUM = 1;
    private boolean isFirstLoad = true;
    private boolean isCancel = false;

    public FlightContentView(Context context, Handler mSessionManagerHandler, String origin,
        ...
        initView(origin, destination,text);
    }

    private void initView(String origin, String destination,String text) {
        ...
        // 设置waittingView
        titleText = (TextView) findViewById(R.id.tv_title_search_flight);
            ...
            mFlightWebView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (isFirstLoad && !isCancel) {
                        ...
                        mFlightWebView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                                height));
    ...
    private void playTTS(String ttsContent) {
        ...
        bundle.putString(SessionPreference.KEY_BUNDLE_EVENT_NAME,
                SessionPreference.EVENT_NAME_PLAY_TTS);
        bundle.putString(SessionPreference.KEY_BUNDLE_PROTOCAL, GuiProtocolUtil
                .getPlayTTSEventParam(ttsContent, GuiProtocolUtil.EVENT_PARAM_KEY_TTS_END_WAKEUP));
        msg.obj = bundle;
        Logger.d(TAG, "playTTS---ttsContent = " + ttsContent);
