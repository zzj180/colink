...
/*
 * 含有中文的联系人基础数据条目，保留中文、全半角英文a-z大小写、全半角数字0-9、基本符号集
 * 不含有中文的联系人基础数据条目，保留全半角英文a-z大小写、全半角数字0-9、基本符号集、以及空格。
 * 只去掉不在基本符号集定义中的符号（如其它全、半角标点符号、西文、葡文、制表符、数学符号等），
 * 得到由上述保留内容单一或混合而成的字符串
 */
public class IllegalCharsRemover
{
	...
	/*
	 * 对包含中文的词进行处理, 结果存入outputArrayList
	 * 中文、全半角英文a-z大小写、全半角数字0-9、基本符号集
	 */
	...
	/*
	 * 对不包含中文的词进行处理
	 * 全半角英文a-z大小写、全半角数字0-9、基本符号集、以及空格
	 */
	...
	private Pattern extractPatternForChinese = Pattern.compile("([a-zａ-ｚA-ZＡ-Ｚ０-９0-9\u4E00-\u9FA5\\.．@＠]+)");
