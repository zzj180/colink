	...
	private String getContactNameById(Context ctx, String contactId) {
		...
		try {
			cursor = ctx.getContentResolver().query(
					...
					ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = '" + contactId + "'", // WHERE clause.
			...
			for( int i = 0; i < cursor.getCount(); i++ ){
				...
				Logger.d(TAG, "!--->name = " + name + ";nameFieldColumnIndex = " + nameFieldColumnIndex);//FC ?
			}
    ...
    public static void testReadAllContacts(Context ctx) {
        ...
        while(cursor.moveToNext()) {
            ...
            while(phones.moveToNext()) {
                ...
                Log.i(TAG, "!--->contactId = "+contactId+"; name = "+name+"; phoneNumber = "+phoneNumber);
             ...
             * 查找该联系人的email信息
             */
//            Cursor emails = ctx.getContentResolver().query(ContactsContract.CommonDataKinds.Email.CONTENT_URI, 
//                    null, 
