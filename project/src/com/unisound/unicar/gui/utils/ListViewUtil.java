...
public class ListViewUtil {
	 ...
	 * @param borderHight
	 */
	public static void setListViewHeightBasedOnScreen(Context context, ListView listView, int borderHight) {
	 ...
	 * @param borderHight
	 */
	public static void setListViewHeightBasedOnChildren(Context context, ListView listView, int borderHight) {
