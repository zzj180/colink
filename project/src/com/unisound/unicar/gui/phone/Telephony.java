...
public class Telephony {
	...
	public static void answerRingingCall(Context context) {
		...
		try {
			...
			e.printStackTrace();
			Logger.e(TAG, "Error trying to answer using telephony service.  Falling back to headset.");
	...
	public static void endCall(Context context) {
		...
		try {
			...
			e.printStackTrace();
			Logger.d(TAG, "Error trying to endCall using telephony service.  Falling back to headset.");
			answerPhoneHeadsetHook(context);
		}
	}
