...
import com.unisound.unicar.gui.location.operation.BaiduMapSdk;
import com.unisound.unicar.gui.location.operation.BaiduUriApi;
...
public class RomDevice {
	...
	public static void showRoute(Context context, String mode, double fromLat, double fromLng, String fromCity,
		...
		if (mHasBaiduMapClient) {
			...
			BaiduMapSdk.showRoute(context, mode, fromLat, fromLng, fromCity, fromPoi, toLat, toLng, toCity, toPoi);
		}
	}
}
