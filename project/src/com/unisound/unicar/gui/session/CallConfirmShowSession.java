...
public class CallConfirmShowSession extends ContactSelectBaseSession {
	...
	protected ICallContentViewListener mCallContentViewListener = new ICallContentViewListener() {
		...
		public void onCancel() {
			Logger.d(TAG, "!--->mCallContentViewListener---onCancel()--mOriginType = "+mOriginType);
			mCancelProtocal = SessionPreference.EVENT_PROTOCAL_ON_CONFIRM_CANCEL_CALL;
			onUiProtocal(SessionPreference.EVENT_NAME_ON_CONFIRM_CANCEL, mCancelProtocal); //xd modify 20150702
			mSessionManagerHandler.sendEmptyMessage(SessionPreference.MESSAGE_SESSION_DONE); //xd modify 20150702
		}
		...
		public void onOk() {
            ...
            onUiProtocal(SessionPreference.EVENT_NAME_ON_CONFIRM_OK, mOkProtocal); //xd modify 20150702
		...
		public void onTimeUp() {
			...
			onUiProtocal(SessionPreference.EVENT_NAME_ON_CONFIRM_TIME_UP, SessionPreference.EVENT_PROTOCAL_ON_CONFIRM_TIME_UP); //xd added 20150702
            mSessionManagerHandler.sendEmptyMessage(SessionPreference.MESSAGE_SESSION_DONE);
		}
	};
	...
	/* {"data":{"functionName":"onTalkProtocol","params":{"type":{"origin_code":"CALL","domain":"SESSION_SHOW",
	  "data":{"schedule_type":"CONFIRM_CALL","number":"11111","text":"第一个","name":"张三"},
	  "tts":"正在为您准备电话","type":"CONFIRM_CALL","origin_type":"cn.yunzhisheng.call"},"functionID":"4"}},"type":"CALL","moduleName":"VUI"} */
	
	
	/*
	   {"origin_code":"CALL","domain":"SESSION_SHOW","data":{"schedule_type":"CONFIRM_CALL","number":"11111","text":"第一个","name":"张三"},
	   "tts":"正在为您准备电话","type":"CONFIRM_CALL","origin_type":"cn.yunzhisheng.call"}
	  */
	@SuppressWarnings("deprecation")
	public void putProtocol(JSONObject jsonProtocol) {
		super.putProtocol(jsonProtocol);
		Logger.d(TAG, "!--->--putProtocol()--mStepTag+"+mStepTag+"; jsonProtocol = "+jsonProtocol);
		if (mStepTag) return;
		Logger.d(TAG, "!--->--putProtocol()--mDataObject = "+mDataObject);//mJSONObject--->mDataObject
		//mDataObject = {"schedule_type":"CONFIRM_CALL","text":"打电话给刘蓓","number":"10086","on_confirm_ok":"{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"OK\"}},\"text\":\"确定\",\"code\":\"SETTING_EXEC\"}","on_confirm_cancel":"{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"CANCEL\"}},\"text\":\"取消\",\"code\":\"SETTING_EXEC\"}","name":"刘备"}
		...
		Logger.d(TAG, "!--->--putProtocol()--number = "+number+"; displayName = "+displayName+"; tag = "+tag);
		int photoId = 0;
		try {
		...
		Logger.d(TAG, "!--->sendMessage : MESSAGE_ADD_ANSWER_VIEW--mCallContentView = "+mCallContentView);
