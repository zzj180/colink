...
public class CommBaseSession extends BaseSession implements ISessionUpdate {
	...
	public void addSessionView(View view) {
		Log.d(TAG, "!--->addSessionView()----view="+view);
		addAnswerView(view);
	}
	...
	public void putProtocol(JSONObject jsonObject) {
		...
		//mJsonObject = getJSONObject(mDataObject, SessionPreference.KEY_RESULT);//TODO: KEY_RESULT-->"data"   error NO THIS KEY KEY_RESULT
		...
		if(mOkProtocal == null){
			...
			Logger.d(TAG, "!--->putProtocol()-mOkProtocal is null, set mOkProtocal = "+mOkProtocal);
		}
