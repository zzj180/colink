...
public class StockShowSession extends BaseSession {
	...
	public void putProtocol(JSONObject jsonProtocol) {
		...
		mQuestion = JsonTool.getJsonValue(resultObject, "name", "") + mContext.getString(R.string.to_stock);
		...
		stockInfo.setChangeAmount(Double.parseDouble(JsonTool.getJsonValue(resultObject, "changeAmount", "0.0")));
		...
		stockInfo.setYesterdayClosingPrice(JsonTool.getJsonValue(resultObject, "yesterdayClosePrice", ""));
