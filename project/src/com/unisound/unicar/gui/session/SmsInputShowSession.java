...
public class SmsInputShowSession extends CommBaseSession {
	...
	private ISmsContentViewListener mSmsContentViewListener = new ISmsContentViewListener() {
		...
		public void onClearMessage() {
			...
			onUiProtocal(SessionPreference.EVENT_NAME_SMS_CONTENT_RETYPE, SessionPreference.EVENT_PROTOCAL_SMS_CONTENT_RETYPE);
		}
	...
	public void putProtocol(JSONObject jsonProtocol) {
		...
		if (mDataObject != null) {
			...
			mSmsContentView.initRecipient(drawable, mSelectedContactInfo.getDisplayName(), mContactNumber + " " + tag);
		}
