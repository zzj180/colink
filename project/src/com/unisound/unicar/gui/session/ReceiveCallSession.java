...
public class ReceiveCallSession extends ContactSelectBaseSession {
	...
	public void putProtocol(JSONObject jsonProtocol) {
		...
		if (mReceiveCallView == null) {
			...
			mReceiveCallView = new ReceiveCallView(mContext, mSelectedContactInfo.getDisplayName(),
...
//		mSessionManagerHandler.sendMessage(msg);
	...
	IReceiveCallViewListener mReceiveCallViewListener = new IReceiveCallViewListener(){
		...
		public void onRejectInComingCall() {
			...
			onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_CALL, SessionPreference.EVENT_PROTOCAL_ON_REJECT_CALL); 
		...
		public void onAnswerInComingCall() {
			...
			// TODO Auto-generated method stub
			onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_CALL, SessionPreference.EVENT_PROTOCAL_ON_ANSWER_CALL); 
