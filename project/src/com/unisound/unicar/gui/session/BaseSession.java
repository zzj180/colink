...
public abstract class BaseSession {
	...
	public void putProtocol(JSONObject jsonProtocol) {
		...
		if (mDataObject != null) {
			...
			mType = JsonTool.getJsonValue(mDataObject, SessionPreference.KEY_DATA_SCHEDULE_TYPE, "");//XD added
	...
	protected void addAnswerView(View view, boolean fullScroll) {
		Log.d(TAG, "!--->addAnswerView----view="+view);
		if (view == null) {
			return;
		}
...
//已废弃 zhuoran
	...
	protected void addSessionViewContainsListView(View view) {
		Log.d(TAG, "!--->addSessionViewContainsListView----view="+view);
		if (view == null) {
			return;
		}
...
//	}
	...
	/**
	 * delay send route and localsearch result message
	 * add tyz 20150729 
	 * @param str
	 */
