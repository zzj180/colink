...
public class ActivityTest extends Activity implements OnClickListener{
	...
	public void onClick(View view) {
		...
		case R.id.btnConn:
			...
			break;
		case R.id.btnReg:
			String systemCall = "{\"type\":\"REG\",\"data\":{\"version\":\"v3.0\",\"moduleName\":\"GUI\",\"callNameList\":[{\"callName\":\"showRecognizerDialog\"},{\"callName\":\"inputContact\"},{\"callName\":\"selectContact\"}]}}";
			sendMsg(systemCall);
			break;
		case R.id.btnSendEvent:
			String eventMsg = "{\"type\":\"EVENT\",\"data\":{\"moduleName\":\"GUI\",\"eventName\":\"PTT\"}}";
			sendMsg(eventMsg);
			break;
		case R.id.btnSendMsg:
			String sengMsg = "{\"type\":\"RESP\",\"data\":{\"moduleName\":\"GUI\",\"callID\":\"1\",\"callName\":\"searchPOI\",\"params\":{\"searchPOI_state\":\"ok\",\"searchPOI_RES\":\"人民广场东门,人民广场西门\"}}}";
			sendMsg(sengMsg);
			break;
		//Test
