...
public class DefaultHttpRequest {
	 ...
	 * @throws Exception
	 */
	public static String getHttpResponse(String url, String method, byte[] body, int connect_timeout, int read_timeout)
																														throws Exception {
			...
			if ("GET".equals(method.toUpperCase())) {
				...
				try {
					...
					if (connection.getResponseCode() != HttpURLConnection.HTTP_OK) {
						throw new Exception("Unexpected HTTP response: " + connection.getResponseCode() + " "
	 ...
	 * @throws Exception
	 */
	public static String getHttpResponse(String url, String method, int readTimeout) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String getHttpResponse(String url, String method, int connectTimeout, int readTimeout)
																										throws Exception {
	...
	public static String sendPost(String url, String param, int connectTimeout, int readTimeout) {
		...
		try {
			...
			Log.d(TAG, "发送POST请求过程中出错：" + e.getMessage());
		} finally {
			try {
				if (out != null) {
					out.close();
