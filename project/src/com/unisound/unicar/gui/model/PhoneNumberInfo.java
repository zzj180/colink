...
public class PhoneNumberInfo {
	...
	public String toString() {
		return "ContactType:" + contactType + ",Id:" + id + ",ContactId:" + contactId + ",Number:" + number + ",Attribution:" + attribution + ",RawNumber:" + rawNumber + ",type:" + type + ",label:" + label
				+ ",PrimaryValue:" + primaryValue + ",SuperPrimaryValue:" + superPrimaryValue;
	}
