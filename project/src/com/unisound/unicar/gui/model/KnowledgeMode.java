...
public class KnowledgeMode {
	...
	public static String getRecognitionNoResultAnswer(Context context, String message) {
		if (!TextUtils.isEmpty(message)) {
			String[] grammerKeyWordCall = KnowledgeBase.getStringArray(
				context,
				R.array.knowledge_grammer_keyword_call);
			...
			String[] grammerKeyWordSms = KnowledgeBase.getStringArray(context, R.array.knowledge_grammer_keyword_sms);
			...
			String[] grammerKeyWordWeather = KnowledgeBase.getStringArray(
				context,
				R.array.knowledge_grammer_keyword_weather);
			...
			String[] grammerKeyWordApp = KnowledgeBase.getStringArray(context, R.array.knowledge_grammer_keyword_app);
			...
			String[] grammerKeyWordMemo = KnowledgeBase.getStringArray(
				context,
				R.array.knowledge_grammer_keyword_memo);
			...
			String[] grammerKeyWordSearch = KnowledgeBase.getStringArray(
				context,
				R.array.knowledge_grammer_keyword_search);
