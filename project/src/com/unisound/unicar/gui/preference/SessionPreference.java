...
//music XD added 20150901
	...
	public static final int VALUE_SET_STATE_TYPE_WAKEUP_INIT_DONE = 0; //wakeup初始化完成
	public static final int VALUE_SET_STATE_TYPE_WAKEUP_SUCCESS = 1;  //唤醒成功
	public static final int VALUE_SET_STATE_TYPE_ASR_COMPILE_FINISH = 2; // 数据编译完成
	public static final int VALUE_SET_STATE_TYPE_WRITE_CONTACT_INFO =5; //取联系人
	public static final int VALUE_SET_STATE_TYPE_WRITE_MEDIA_INFO =9; //取媒体数据
	public static final int VALUE_SET_STATE_TYPE_GET_SUPPORT_DOMAIN_LIST = 8;  //TODO: GET SUPPORT DOMAIN LIST
	public static final int VALUE_SET_STATE_TYPE_WRITE_APPS_INFO = 10;//读取app add by tyz 0709
	public static final int VALUE_SET_STATE_TYPE_WAKEUP_SUCCESS_DORESO = 19;  //唤醒成功
	
	public static final String VALUE_FUNCTION_NAME_SET_STATE = "setState"; //functionID = 0
	public static final String VALUE_FUNCTION_NAME_ON_RECORDING_START = "onRecordingStart"; //functionID = 1
	public static final String VALUE_FUNCTION_NAME_ON_RECORDING_STOP = "onRecordingStop"; //functionID = 2
	public static final String VALUE_FUNCTION_NAME_ON_TALK_PROTOCOL = "onTalkProtocol"; //functionID = 3
	public static final String VALUE_FUNCTION_NAME_IS_ASR_COMPILE_DONE = "isASRCompileDone"; //functionID = 4
	public static final String VALUE_FUNCTION_NAME_ON_UPDATE_VOLUME = "onUpdateVolume"; //functionID = 5
	public static final String VALUE_FUNCTION_NAME_ON_TTS_PLAY_END = "onTTSPlayEnd"; //functionID = 6
	public static final String VALUE_FUNCTION_NAME_ON_RECORDING_PREPARED = "onRecordingPrepared"; //functionID = 7
	...
	public static final String VALUE_FUNCTION_NAME_ON_TALK_RESULT = "onTalkResult";//functionid= 16
	public static final String VALUE_FUNCTION_NAME_ON_RECOGNIZER_TIMEOUT = "onRecognizerTimeout";//functionid= 17
	
	public static final String VALUE_FUNCTION_NAME_ON_CTT_CANCEL = "onCTTCancel";//functionid= 18 
	public static final String VALUE_FUNCTION_NAME_FETCH_UPDATE_CONTACT_DONE = "onFetchUpDateContactDone";
	public static final String VALUE_FUNCTION_NAME_FETCH_UPDATE_MEDIA_DONE = "onFetchUpDateMediaDone";
	public static final String VALUE_FUNCTION_NAME_FETCH_UPDATE_APP_DONE = "onFetchUpDateAppDone";
	
	public static final String VALUE_FUNCTION_NAME_FETCH_WAKEUP_WORDS_DONE = "onFetchWakeUpWordsDone";//functionid=20
	...
	public static final String VALUE_SCHEDULE_TYPE_SCHEDULE_ERROR = "SCHEDULE_ERROR"; //add 20150701
	public static final String VALUE_SCHEDULE_TYPE_SCHEDULE_ERROR_END = "SCHEDULE_ERROR_END"; //add 20150703
	public static final String VALUE_SCHEDULE_TYPE_NO_PERSON = "NO_PERSON";//can't find contacts
	public static final String VALUE_SCHEDULE_TYPE_NO_NUMBER = "NO_NUMBER";//find contacts but no number
	public static final String VALUE_SCHEDULE_TYPE_ACTION_CANCEL = "ACTION_CANCEL";
	public static final String VALUE_SCHEDULE_TYPE_ONLINE_ERROR = "ONLINE_ERROR";//not connect network, add 20150706
	public static final String VALUE_SCHEDULE_TYPE_WEATHER_ERROR_SHOW = "WEATHER_ERROR_SHOW";//added 20150715
	
	public static final String VALUE_SCHEDULE_TYPE_INCOMING_CALL = "INCOMING_CALL_SHOW";
	public static final String VALUE_SCHEDULE_TYPE_INCOMING_CALL_OPERATOR = "INCOMING_CALL_OPERATOR_SHOW";
	
	//added 20150717 for incoming SMS
	public static final String VALUE_SCHEDULE_TYPE_INCOMING_SMS = "INCOMING_SMS_SHOW";
	public static final String VALUE_SCHEDULE_TYPE_INCOMING_SMS_OPERATOR = "INCOMING_SMS_OPERATOR_SHOW";
	...
	public static final String VALUE_SCHEDULE_TYPE_MUSIC_RESULT_SHOW = "MUSIC_RESULT_SHOW";//XD added 20150828
	
	public static final String VALUE_SCHEDULE_TYPE_STOCK_NO_RESULT = "STOCK_NO_RESULT";//WLP added 20150821
	...
	public static final String VALUE_TYPE_LOCALSEARCH_CALL_SHOW = "LOCALSEARCH_CALL_SHOW";//add tyz 0824
	...
	// sms
	public static final String VALUE_SCHEDULE_TYPE_INPUT_CONTENT_SMS = "INPUT_CONTENT_SMS"; //xd added 20150706
    public static final String VALUE_SCHEDULE_TYPE_INPUT_SMS_CONFIRM = "INPUT_SMS_CONFIRM";//xd added 20150709
	...
	//public static final String VALUE_TYPE_INPUT_MSG_CONTENT = "INPUT_FREETEXT_SMS";//INPUT_SMS_CONTENT
	...
	public static final String EVENT_NAME_FETCH_WAKEUP_WORD = "FETCH_WAKEUP_WORD";
	...
	public static final String EVENT_NAME_ON_CONFIRM_TIME_UP = "ON_CONFIRM_TIME_UP"; //xd added 20150704
	...
	public static final String EVENT_NAME_SMS_CONTENT_RETYPE = "SMS_CONTENT_RETYPE";//xd added 20150708
	...
	public static final String EVENT_NAME_INCOMING_SMS_REPLY = "INCOMING_SMS_REPLY"; //XD added 20150819
	...
	/* EVENT PROTOCAL */
	public static final String EVENT_PROTOCAL_ON_CONFIRM_OK = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"OK\"}},\"code\":\"SETTING_EXEC\"}";
	//	public static final String EVENT_PROTOCAL_ON_CONFIRM_CANCEL = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"CANCEL\"}},\"code\":\"SETTING_EXEC\"}";
	public static final String EVENT_PROTOCAL_ON_CONFIRM_CANCEL_CALL = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"CANCEL\"}},\"code\":\"SETTING_EXEC\",\"type\":\"CALL\"}";
	public static final String EVENT_PROTOCAL_ON_CONFIRM_CANCEL_SMS = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"CANCEL\"}},\"code\":\"SETTING_EXEC\",\"type\":\"SMS\"}";
	public static final String EVENT_PROTOCAL_ON_CONFIRM_TIME_UP = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"TIME_UP\"}},\"code\":\"SETTING_EXEC\"}";
	public static final String EVENT_PROTOCAL_SMS_CONTENT_RETYPE = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"REINPUT\"}},\"code\":\"SETTING_EXEC\"}";

	public static final String EVENT_PROTOCAL_SMS_STATUS_SUCCESS = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"SMS_SENT_STATUS\"}},\"code\":\"SETTING_EXEC\",\"type\":\"SUCCESS\"}";
	public static final String EVENT_PROTOCAL_SMS_STATUS_FAIL = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"SMS_SENT_STATUS\"}},\"code\":\"SETTING_EXEC\",\"type\":\"FAIL\"}";

	public static final String EVENT_PROTOCAL_ON_ANSWER_CALL = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"OK\"}},\"code\":\"SETTING_EXEC\",\"state\":\"INCOMING_CALL_ANSWER\"}";
	public static final String EVENT_PROTOCAL_ON_REJECT_CALL = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"CANCEL\"}},\"code\":\"SETTING_EXEC\",\"state\":\"INCOMING_CALL_HANGUP\"}";
	...
	//acc WakeUp protocal
	public static final String EVENT_PROTOCAL_SWITCH_WAKEUP_START_ACC = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"WAKEUP_START\"}},\"code\":\"SETTING_EXEC\",\"state\":\"WAKEUP_START\",\"extra\":\"ACC\"}";
	public static final String EVENT_PROTOCAL_SWITCH_WAKEUP_STOP_ACC = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"WAKEUP_STOP\"}},\"code\":\"SETTING_EXEC\",\"state\":\"WAKEUP_STOP\",\"extra\":\"ACC\"}";
	//Add send switch WakeUp protocol
	public static final String EVENT_PROTOCAL_SWITCH_WAKEUP_START = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"WAKEUP_START\"}},\"code\":\"SETTING_EXEC\",\"state\":\"WAKEUP_START\"}";
	public static final String EVENT_PROTOCAL_SWITCH_WAKEUP_STOP = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"WAKEUP_STOP\"}},\"code\":\"SETTING_EXEC\",\"state\":\"WAKEUP_STOP\"}";
	//Add send switch TTSSpeed protocol
	public static final String EVENT_PROTOCAL_SWITCH_TTS_SPEED_SLOWLY = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"TTS_SPEED_SLOWLY\"}},\"code\":\"SETTING_EXEC\",\"state\":\"TTS_SPEED_SLOWLY\"}";
	public static final String EVENT_PROTOCAL_SWITCH_TTS_SPEED_STANDARD = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"TTS_SPEED_STANDARD\"}},\"code\":\"SETTING_EXEC\",\"state\":\"TTS_SPEED_STANDARD\"}";
	public static final String EVENT_PROTOCAL_SWITCH_TTS_SPEED_FAST = "{\"service\":\"cn.yunzhisheng.setting\",\"semantic\":{\"intent\":{\"confirm\":\"TTS_SPEED_FAST\"}},\"code\":\"SETTING_EXEC\",\"state\":\"TTS_SPEED_FAST\"}";
