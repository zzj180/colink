...
public class AMapLocateClient extends BaseLocateClient {
	...
	private AMapLocationListener mLocationListener = new AMapLocationListener() {
		...
		public void onLocationChanged(AMapLocation location) {
			...
			//只在操作正确情况下，执行回调。
			Log.d(TAG,"location.getAMapException().getErrorCode() = "+location.getAMapException().getErrorCode());
	...
	public void startLocate() {
		...
		mLocationManager.requestLocationData(LocationProviderProxy.AMapNetwork, 2000, 10, mLocationListener);
	}
