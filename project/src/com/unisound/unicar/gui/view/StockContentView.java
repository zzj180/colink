...
public class StockContentView extends FrameLayout implements ISessionView {
	...
	private TextView mTextViewCurrentPrice, mTextViewChangeAmount, mTextViewChangeRate, mTextViewHighestPrice, mTextViewLowestPrice, mTextViewYesterdayClosingPrice,
	...
	public StockContentView(Context context) {
		super(context);
		mImageDownloader = new ImageDownloader(AssistantPreference.FOLDER_PACKAGE_CACHE + AssistantPreference.FOLDER_IMG, 0);
	...
	private void findViews() {
		...
		mTextViewYesterdayClosingPrice = (TextView) findViewById(R.id.textViewStockYesterdayClosingPrice);
...
//        mTextViewChangeRate.setText(result.getChangeRate() + "%");
        ...
        mTextViewTodayOpeningPrice.setText(getResources().getString(R.string.stock_pening_price, result.getTodayOpeningPrice()));
        mTextViewYesterdayClosingPrice.setText(getResources().getString(R.string.stock_closing_price, result.getYesterdayClosingPrice()));
        mTextViewHighestPrice.setText(getResources().getString(R.string.stock_highest_price, result.getHighestPrice()));
        mTextViewLowestPrice.setText(getResources().getString(R.string.stock_lowest_price, result.getLowestPrice()));
...
//            mImgTrend.setImageResource(R.drawable.ic_stock_trend_down);
        ...
        mImageDownloader.download(result.getChartImgUrl(), mImgChart, true, ImageDownloader.SCALE_BY_IMAGEVIEW_WIDTH);
    }
}
