...
public class GeneralAnswerView extends FrameLayout implements ISessionView {
	...
	public void setGeneralData(String text, String imgURL, String imgAlt, String url, String urlAlt) {
		mText = text;
		mImageURL = imgURL;
		mImageAlt = imgAlt;
		mURL = url;
	...
	private void refreshView() {
		if (mImageURL == null || mImageURL.equals("")) {
			...
			mImageDownloader
				.download(mImageURL, mImageViewGeneralImage, true, ImageDownloader.SCALE_BY_IMAGEVIEW_WIDTH);
		}
		...
		if (mContext != null) {
			...
			if (intent != null) {
				...
				if (apps != null && apps.size() > 0) {
					...
					Toast.makeText(mContext, R.string.view_sorry, Toast.LENGTH_SHORT).show();
				}
			}
		}
	}
