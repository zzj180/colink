...
public class LoadViewLinearLayout extends LinearLayout {
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		Logger.d(TAG, "!--->dispatchKeyEvent: getKeyCode = "+event.getKeyCode()+ ", Action = " + event.getAction());
		if(event.getKeyCode() == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_UP) {
			//Do not response ACTION_UP
			Logger.d(TAG, "!--->Back pressed. KeyCode = " + event.getKeyCode() + ", Action = " + event.getAction());
			return true;
		}
