...
public class MicRecordingSessionView extends LinearLayout implements ISessionView {
	...
	/**
	 * get Random show text list which size is COUNT_DEFAULT_SHOW
	 * from SupportDomain list 
	 * @return
	 */
	private ArrayList<String> getShowTexts(){
		ArrayList<String> showTexts = new ArrayList<String>();
		/*< XD 20150807 modify begin */
		ArrayList<SupportDomain> supprotList = FunctionHelpUtil.getUnsupportedHelpTextList(mContext);
		/* XD 20150807 modify End > */
		int[] indexArray = ArithmeticUtil.getRandomArray(0, supprotList.size() - 1, COUNT_DEFAULT_SHOW) ;
