...
//	private Handler mSessionManagerHandler = null;
	...
	private OnClickListener mOnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			//mSessionManagerHandler.sendEmptyMessage(SessionPreference.MESSAGE_ANSWER_CALL); //xd delete 20150710
		}
	};
	 ...
	 * @param location
	 */
	public ReceiveCallView(Context context, String name, String number, Drawable drawable, String location) {
		super(context);
