...
//		mPreference = new UserPreference(context);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Logger.d(TAG, "!--->onTouchEvent---action = "+ev.getAction()+"; mScrollable = "+ mScrollable);
		switch (ev.getAction()) {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		Logger.d(TAG, "!--->onInterceptTouchEvent----action="+ev.getAction()+"; ; mScrollable = "+ mScrollable);
		if (mScrollable) {
