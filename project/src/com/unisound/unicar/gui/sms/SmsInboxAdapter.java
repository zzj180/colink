...
public class SmsInboxAdapter extends BaseAdapter {
	...
	public int loadNextPage() {
		if (mCurrentPage < mPages) {
			...
			int end = (count + mPageSize) < mCursor.getCount() ? (count + mPageSize) : mAllCountSize;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String dateTime = DateFormat.format(mContext.getString(R.string.sms_date_format), time).toString();
