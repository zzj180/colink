...
public class ServiceState implements Parcelable {
	...
	public int hashCode() {
		return ((mState * 0x1234)
				...
				+ ((null == mOperatorAlphaLong) ? 0 : mOperatorAlphaLong
					.hashCode())
				+ ((null == mOperatorAlphaShort) ? 0 : mOperatorAlphaShort
					.hashCode())
	...
	public boolean equals(Object o) {
		...
		return (mState == s.mState
				...
				&& equalsHandlesNulls(
					...
					s.mCdmaRoamingIndicator) && equalsHandlesNulls(
	...
	public String toString() {
		...
		return (mState + " " + (mRoaming ? "roaming" : "home") + " "
				...
				+ mNetworkId + " " + mSystemId + "RoamInd: "
				+ mCdmaRoamingIndicator + "DefRoamInd: " + mCdmaDefaultRoamingIndicator);
	}
	...
	public void setOperatorName(String longName, String shortName,
								String numeric) {
	 ...
	 * text, this is done from the CDMAPhone and not from the
