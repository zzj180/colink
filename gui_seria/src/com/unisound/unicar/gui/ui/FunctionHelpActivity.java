 ...
 * 
 * @FileName : FunctionHelpActivity.java
...
public class FunctionHelpActivity extends Activity {
    ...
    private void initBluetoothHelpView() {
      ...
      /*  LinearLayout smsFunctionHelpLayout = (LinearLayout) findViewById(R.id.ll_sms_function_help);
        ...
        String[] callOfflineArray =
                mContext.getResources().getStringArray(R.array.help_child_content_outcall_offline);
        tvCallOffline1.setText(callOfflineArray[0]);
        tvCallOffline2.setText(callOfflineArray[1]);

        String[] callOnlineArray =
                mContext.getResources().getStringArray(R.array.help_child_content_outcall_online);
        tvCallOnline1.setText(callOnlineArray[0]);
        tvCallOnline2.setText(callOnlineArray[1]);

        String[] inCallOfflineArray =
                mContext.getResources().getStringArray(R.array.help_child_content_incall_offline);
        tvInCallOffline1.setText(inCallOfflineArray[0]);
        tvInCallOffline2.setText(inCallOfflineArray[1]);

        //delete by zzj 2015.12.03
      /*  if (GUIConfig.isShowSMSFunctionHelp) {
            smsFunctionHelpLayout.setVisibility(View.VISIBLE);
            String[] smsOnlineArray =
                    mContext.getResources().getStringArray(R.array.help_child_content_sms_online);
            tvSendSMSOnline1.setText(smsOnlineArray[0]);
            tvSendSMSOnline2.setText(smsOnlineArray[1]);
        } else {
            smsFunctionHelpLayout.setVisibility(View.GONE);
        }*/
    }
    ...
    private ArrayList<FunctionHelpTextInfo> getHelpTextInfo() {
        ...
        switch (mHelpType) {
            ...
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_NAVIGATION:
                mFunctionHelpList =
                        getArrayListByArrayRes(R.array.help_child_content_navigation_offline,
                                R.array.help_child_content_navigation_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_MUSIC:
                mFunctionHelpList =
                        getArrayListByArrayRes(R.array.help_child_content_music_offline,
                                R.array.help_child_content_music_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_SETTING:
                mFunctionHelpList =
                        getArrayListByArrayRes(R.array.help_child_content_setting_offline, 0);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_NET_RADIO:
                mFunctionHelpList =
                        getArrayListByArrayRes(R.array.help_child_content_net_radio_offline,
                                R.array.help_child_content_net_radio_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_WEATHER:
                mFunctionHelpList =
                        getArrayListByArrayRes(0, R.array.help_child_content_weather_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_STOCK:
                mFunctionHelpList =
                        getArrayListByArrayRes(0, R.array.help_child_content_stock_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_LOCAL_SEARCH:
                mFunctionHelpList =
                        getArrayListByArrayRes(0, R.array.help_child_content_local_search_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_TRAFFIC:
                mFunctionHelpList =
                        getArrayListByArrayRes(0, R.array.help_child_content_traffic_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_LIMIT:
                mFunctionHelpList =
                        getArrayListByArrayRes(0, R.array.help_child_content_limit_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_RADIO:
                mFunctionHelpList =
                        getArrayListByArrayRes(R.array.help_child_content_radio_offline,
                                R.array.help_child_content_radio_online);
                break;
            case GUIConfig.VALUE_FUNCTION_HELP_TYPE_WAKEUP:
            	String wakeup_words = UserPerferenceUtil.getWakeupWords(mContext);
     ...
     * @return
     */
    private ArrayList<FunctionHelpTextInfo> getArrayListByArrayRes(int offlineArrayRes,
            int onlineArrayRes) {
        ArrayList<FunctionHelpTextInfo> mFunctionHelpList = new ArrayList<FunctionHelpTextInfo>();
