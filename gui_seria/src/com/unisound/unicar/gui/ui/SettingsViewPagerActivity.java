...
public class SettingsViewPagerActivity extends Activity {
    ...
    private LinearLayout mVersionModeLayout;
        ...
        public Object instantiateItem(View container, int position) {
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    mVersionModeLayout = (LinearLayout) findViewById(R.id.ll_setting_version_mode);
                    ...
                    // Page2 Extra Layout, XD added 20151123
                    mPage2ExtraLayout = (LinearLayout) findViewById(R.id.ll_page2_extra);
                    if (GUIConfig.isSupportAECSetting) {
                        mPage2ExtraLayout.setVisibility(View.GONE);
                    } else {
                        mPage2ExtraLayout.setVisibility(View.VISIBLE);
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    ...
                    switch (checkedId) {
                        case R.id.rBtn_map_gaode:
                            ...
                            Settings.System.putInt(mContext.getContentResolver(), SettingMapViewPagerActivity.MAP_INDEX, 1);
                        ...
                        case R.id.rBtn_map_baidu:
                            ...
                            Settings.System.putInt(mContext.getContentResolver(), SettingMapViewPagerActivity.MAP_INDEX, 0);
                        ...
                        case R.id.rBtn_version_mode_3:
                            ...
                            String helpText =
                                    getString(R.string.setting_help_text_version_mode_3,
                                            UserPerferenceUtil.getWakeupWord(mContext));
                            showHelpTextPopWindow(mContext,
                                    getString(R.string.setting_help_title_version_mode_3), helpText);
                            break;
                        default:
                            break;
                    }
    ...
    private void sendVersionLevelConfigure() {
        sendConfigure(WindowService.ACTION_SET_VERSION_LEVEL);
    }
    ...
    private void showHelpTextPopWindow(Context context, String titleRes, String contentRes) {
        Logger.d(TAG, "showHelpTextPopWindow----");
     ...
     * @param context
     */
    private void showHelpTextPopWindow(Context context, int titleRes, int contentRes) {
        Logger.d(TAG, "showHelpTextPopWindow----");
        SettingHelpPopupWindow pop = new SettingHelpPopupWindow(context);
        pop.setTitle(titleRes);
        pop.setContent(contentRes);
