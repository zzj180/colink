	...
	public void putProtocol(JSONObject jsonProtocol) {
		...
		/* XD 20150717 delete End >*/
			...
			if (SessionPreference.VALUE_SETTING_ACT_GO_BACK_HOME.equals(operator)) {
				...
				case 4:
				/*	try {
						forceStopPackage("com.android.camera2", mContext);
					} catch (Exception e1) {
						e1.printStackTrace();
					}*/
					RomApp.lanchApp(mContext, GUIConfig.PACKAGE_NAME_GOOGLE_MAP, GUIConfig.ACTIVITY_NAME_GOOGLE_MAP);
					break;
				default:
...
/*			else if (SessionPreference.VALUE_SETTING_ACT_CLOSE.equals(operator)) {
	...
	private void doOnTTSEnd() {
        ...
        if (SessionPreference.VALUE_SETTING_OBJ_SCREEN.equals(operands) || SessionPreference.VALUE_SETTING_OBJ_DISPLAY.equals(operands)) {		//关屏
			if (SessionPreference.VALUE_SETTING_ACT_CLOSE.equals(operator)) {
