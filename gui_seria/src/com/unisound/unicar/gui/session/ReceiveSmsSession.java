...
/**
 * Receive SMS Operator Session Incoming SMS -> "Broadcast"、"FAST REPLY" & "CANCEL"
 * 
 * @author xiaodong
 * @date 20150717
 */
public class ReceiveSmsSession extends ContactSelectBaseSession {
    ...
    public void putProtocol(JSONObject jsonProtocol) {
        ...
        Logger.d(TAG, "!--->displayName = " + displayName + "; number = " + number + "; content = "
                + content);
    ...
    private IReceiveSMSViewListener mReceiveSMSViewListener = new IReceiveSMSViewListener() {
        ...
        public void onSmsBroadcast() {
            ...
            onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_SMS,
        ...
        public void onSmsFastReply() {
            ...
            onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_SMS_REPLY,
                    GuiProtocolUtil.getSmsFastReplyEventProtocol(
                            SessionPreference.EVENT_PARAM_VALUE_INCOMING_SMS_FAST_REPLY, mName,
                            mNumber, defaultContent));
        ...
        public void onCancel() {
            ...
            onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_SMS,
                    SessionPreference.EVENT_PROTOCAL_ON_CONFIRM_CANCEL_SMS);
        ...
        public void onSmsReply() {
            ...
            onUiProtocal(SessionPreference.EVENT_NAME_INCOMING_SMS_REPLY,
                    GuiProtocolUtil.getSmsReplyEventProtocol(
                            SessionPreference.EVENT_PARAM_VALUE_INCOMING_SMS_REPLY, mName, mNumber));
        }
