...
public class XmFmGuiService extends Service {
    ...
    private Album album;
    private CommonTrackList commonTrackList;
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.CodeSearchAlbumList:
                    ...
                    searchAlbumList =
                            new Gson().fromJson(msg.obj.toString(), SearchAlbumList.class);
                    album = searchAlbumList.getAlbums().get(0);
                ...
                case Constants.CodeCommonTrackList:
                    ...
                    commonTrackList =
                            new Gson().fromJson(msg.obj.toString(), CommonTrackList.class);
