...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static final Cursor query(ContentResolver cr, String[] projection, String where,
                String orderBy) {
            return cr.query(CONTENT_URI, projection, where, null, orderBy == null
                    ? DEFAULT_SORT_ORDER
                    : orderBy);
        }
        ...
        public static boolean moveMessageToFolder(Context context, Uri uri, int folder) {
            ...
            return 1 == SqliteWrapper.update(context, context.getContentResolver(), uri, values,
                    null, null);
        }
        ...
        public static final class Inbox implements BaseColumns, TextBasedSmsColumns {
            ...
            public static Uri addMessage(ContentResolver resolver, String address, String body,
                    String subject, Long date, boolean read) {
                return addMessageToUri(resolver, CONTENT_URI, address, body, subject, date, read,
                        false);
            }
        }
        ...
        public static final class Intents {
            ...
            /**
             * Set by BroadcastReceiver. Indicates the message, while possibly valid, is of a format
             * or encoding that is not supported.
             */
            public static final int RESULT_SMS_UNSUPPORTED = 4;

            /**
             * Broadcast Action: A new text based SMS message has been received by the device. The
             * intent will have the following extra values:</p>
             * 
             * <ul>
             * <li><em>pdus</em> - An Object[] od byte[]s containing the PDUs that make up the
             * message.</li>
             * </ul>
             * 
             * <p>
             ...
             * will have the following extra values:</p>
             * 
             * <ul>
             ...
             * intent is sent in lieu of any of the RECEIVED_ACTION intents. The intent will have
             * the following extra value:</p>
             * 
             * <ul>
             * <li><em>result</em> - An int result code, eg,
             * <code>{@link #RESULT_SMS_OUT_OF_MEMORY}</code>, indicating the error returned to the
             * network.</li>
             * </ul>
             */
            // @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    ...
    public interface CanonicalAddressesColumns extends BaseColumns {
        /**
         * An address used in MMS or SMS. Email addresses are converted to lower case and are
         * compared by string equality. Other addresses are compared using PHONE_NUMBERS_EQUAL.
         * <P>
         * Type: TEXT
         * </P>
         */
    ...
    public interface ThreadsColumns extends BaseColumns {
        ...
        /**
         * A string encoding of the recipient IDs of the recipients of the message, in numerical
         * order and separated by spaces.
         * <P>
         * Type: TEXT
         * </P>
         */
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static final Uri CONTENT_URI = Uri.withAppendedPath(MmsSms.CONTENT_URI,
                "conversations");
        public static final Uri OBSOLETE_THREADS_URI = Uri
                .withAppendedPath(CONTENT_URI, "obsolete");
        ...
        /**
         * This is a single-recipient version of getOrCreateThreadId. It's convenient for use with
         * SMS messages.
         */
         ...
         * existing thread ID.
         * 
         * Find the thread ID of the same set of recipients (in any order, without any additions).
         * If one is found, return it. Otherwise, return a unique thread ID.
         */
        public static long getOrCreateThreadId(Context context, Set<String> recipients) {
            ...
            if (DEBUG) {
                Logger.v(TAG, "getOrCreateThreadId uri: " + uri);
            }
            Cursor cursor =
                    SqliteWrapper.query(context, context.getContentResolver(), uri, ID_PROJECTION,
                            null, null, null);
            if (DEBUG) {
                Logger.v(TAG, "getOrCreateThreadId cursor cnt: " + cursor.getCount());
            }
            if (cursor != null) {
                try {
            ...
            Logger.e(TAG, "getOrCreateThreadId failed with uri " + uri.toString());
    ...
    public static final class Mms implements BaseMmsColumns {
        ...
        public static final Uri REPORT_REQUEST_URI = Uri.withAppendedPath(CONTENT_URI,
                "report-request");

        public static final Uri REPORT_STATUS_URI = Uri.withAppendedPath(CONTENT_URI,
                "report-status");
...
/**
         * mailbox = name-addr name-addr = [display-name] angle-addr angle-addr = [CFWS] "<"
         * addr-spec ">" [CFWS]
         */
        ...
        public static final class ScrapSpace {
             ...
             * the captured image to the uri. Internally we write the media content to this file.
        ...
        public static final class Intents {
            ...
            /**
             * The extra field to store the type of the contents, which should be an array of
             * String.
             */
    ...
    public static final class MmsSms implements BaseColumns {
        ...
        /***
         * Pass in a query parameter called "pattern" which is the text to search for. The sort
         * order is fixed to be thread_id ASC,date DESC.
         */
        ...
        public static final class PendingMessages implements BaseColumns {
            ...
            public static final String MSG_ID = "msg_id";
            /**
             * The type of the message to be sent or downloaded. This field is only valid for MM.
             * For SM, its value is always set to 0.
             */
    ...
    public static final class Intents {
         ...
         * form *#*# <code>#*#*. The intent will have the data URI:</p>
         * 
         ...
         * services that use these strings should update their display. The intent will have the
         ...
         * 
         * It is recommended to display <em>plmn</em> before / above <em>spn</em> if both are
         * displayed.
         * 
         * <p>
