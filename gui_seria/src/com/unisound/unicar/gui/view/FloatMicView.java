...
public class FloatMicView extends FloatView {
    ...
    private OnTouchListener mOnTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            mRawX = event.getRawX();
            if (GUIConfig.isStatusBarOnScreenTop) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    Logger.d(TAG, "!--->ACTION_UP---x = " + mRawX + "; y = " + mRawY
                            + "; mTouchStartX = " + mTouchStartX + "; mTouchStartY = "
                            + mTouchStartY + "; mHasMoved = " + mHasMoved);
    ...
    private void requestAutoDock() {
        ...
        Logger.d(TAG, "requestAutoDock---mWindowParams.x = " + x + "; mScreenSize.x/2 = "
                + mScreenSize.x / 2);
    ...
    private void initViewCtrls() {
        ...
        mBtnFloatMic.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,
    ...
    private void saveViewPostion() {
        Logger.d(TAG, "!--->saveViewPostion---mWindowParams.x = " + mWindowParams.x
                + "; mWindowParams.y = " + mWindowParams.y);
    ...
    private int getFloatViewDefaultLocationY() {
        int floatViewHight =
                mContext.getResources().getDrawable(R.drawable.float_mic_normal)
                        .getIntrinsicHeight();
        int defaultY =
                (DeviceTool.getScreenHight(mContext) + mStatusBarHeight - floatViewHight) / 2; // mWindowSize.y
                                                                                               // /
                                                                                               // 2
                                                                                               // -
                                                                                               // getHeight()
        Logger.d(TAG, "!--->getFloatViewDefaultLoactionY--defaultY = " + defaultY
                + "; floatViewHight = " + floatViewHight);
        return defaultY;
    }
