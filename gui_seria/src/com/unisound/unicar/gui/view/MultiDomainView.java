...
public class MultiDomainView extends FrameLayout implements ISessionView {
    ...
    private void initDomainNameMap() {
        ...
        mDomainNameMap
                .put(SessionPreference.DOMAIN_CONTACT, res.getString(R.string.domain_contact));
        ...
        mDomainNameMap.put(SessionPreference.DOMAIN_SEARCH,
                res.getString(R.string.domain_nearby_search));
        mDomainNameMap
                .put(SessionPreference.DOMAIN_SITEMAP, res.getString(R.string.domain_sitemap));
        ...
        mDomainNameMap
                .put(SessionPreference.DOMAIN_WEATHER, res.getString(R.string.domain_weather));
        ...
        mDomainNameMap.put(SessionPreference.DOMAIN_DIANPING,
                res.getString(R.string.domain_local_search));
        mDomainNameMap
                .put(SessionPreference.DOMAIN_SETTING, res.getString(R.string.domain_setting));
