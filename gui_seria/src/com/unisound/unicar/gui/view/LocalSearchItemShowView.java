 ...
 * 
 */
public class LocalSearchItemShowView extends FrameLayout implements ISessionView {

    private static final String TAG = LocalSearchItemShowView.class.getSimpleName();
    ...
    public void initData(PoiInfo poiInfo) {
        ...
        has_coupon.setVisibility(poiInfo.isHas_coupon() ? View.VISIBLE : View.GONE);
        has_deal.setVisibility(poiInfo.isHas_deal() ? View.VISIBLE : View.GONE);
        has_online_reservation.setVisibility(poiInfo.isHas_online_reservation()
                ? View.VISIBLE
                : View.GONE);

        double dist = mPoiInfo.getDistance() / 1000.00;
        Logger.d(TAG, "!--->--dist = " + dist + "KM; getDistance = " + mPoiInfo.getDistance());
        mTvDistance.setText(mContext.getString(R.string.local_search_distance, dist));
        ...
        if (mPoiInfo.getAvg_price() > 0) {
            ...
            mTvAvgPice.setText(mContext.getString(R.string.local_search_food_price)
        ...
        if (TextUtils.isEmpty(phoneNum)) {
            ...
            mTvCallBtn.setText(mContext.getString(R.string.local_search_no_number));
