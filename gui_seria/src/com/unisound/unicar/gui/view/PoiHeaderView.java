                ...
                case R.id.textViewPoiSort:
                    ...
                    if (mPopupWindowSort == null) {
                        ...
                        for (int i = 0; i < mItems.length; i++) {
                            View item =
                                    mInflater.inflate(R.layout.poi_sort_list_item,
                                            mPopWindowSortContentView, false);
                            item.setTag(i);
                            item.setOnClickListener(mOnClickListener);
                            TextView tv =
                                    (TextView) item.findViewById(R.id.textViewPoiSortItemName);
                    ...
                    mPopupWindowSort.showAtLocation(
                            ...
                            loc[0]
                                    ...
                                    - getContext().getResources().getDimensionPixelSize(
                                            R.dimen.poi_sort_list_item_width), loc[1]
                                    + mTextViewSort.getHeight());
                    break;
